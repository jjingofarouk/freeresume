...
export const Hero = () => {
  return (
    <section className="relative overflow-hidden py-16 lg:flex lg:min-h-[900px] lg:items-center lg:justify-center lg:py-24">
      <div className="absolute inset-0 bg-theme-navy/10" />
      ...
      >
        ...
        <p className="mt-4 text-lg text-theme-light-gray sm:mt-6 sm:text-xl lg:text-2xl xl:text-3xl">
          Create a professional, ATS-optimized resume with our free, open-source platform.
        </p>
        <motion.div
        ...
        >
          ...
          <Link
            href="/resume-parser"
            className="outline-theme-dark-navy inline-block rounded-xl px-8 py-3 text-base font-semibold text-theme-emerald hover:bg-theme-emerald/10 sm:text-lg"
          >
            Analyze Resume
          </Link>
        </motion.div>
        <p className="mt-4 text-sm text-theme-light-gray/80 sm:text-base lg:mt-6">
          No sign-up required. Begin instantly.
        </p>
      </motion.div>
      ...
      >
        <div className="relative">
          <AutoTypingResume />
          <motion.div
            className="absolute inset-0 rounded-2xl bg-theme-emerald/10 blur-2xl"
